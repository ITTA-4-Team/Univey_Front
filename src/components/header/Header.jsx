...
export default function Header() {
  ...
  console.log("키값");
  console.log(key);
  const url = `https://kauth.kakao.com/oauth/authorize?client_id=a7112c7855122c19ace78f063bcce15a&redirect_uri=http://www.univey.net/users/kakao/callback&response_type=code`;
